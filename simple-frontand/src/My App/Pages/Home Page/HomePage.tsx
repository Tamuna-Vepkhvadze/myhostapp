...
const activities = [
  ...
  return (
      ...
      {/* Hero Section */}
      <div className="w-full h-96 flex flex-col justify-center items-center text-center rounded-b-3xl shadow-lg bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-300">
        <h1 className="text-5xl font-bold text-white drop-shadow-lg">Welcome to FunZone!</h1>
        <p className="text-xl text-white mt-2 drop-shadow-md">Discover daily tips, fun activities & news</p>
        <div className="mt-6 flex space-x-4">
          <Link to={"/Registracion"}  className="py-3 px-6 bg-white text-indigo-500 font-semibold rounded-full shadow hover:scale-105 transition-transform">
            Sign Up
          </Link>
          <Link to={"/LogIn"} className="py-3 px-6 bg-indigo-600 text-white font-semibold rounded-full shadow hover:bg-indigo-700 transition-colors">
            Log In
          </Link>
        </div>
      </div>
