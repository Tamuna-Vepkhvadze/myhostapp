  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-indigo-100 flex flex-col items-center px-4 sm:px-8">
      ...
      <div className="w-full max-w-5xl text-center py-16">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-indigo-700 mb-6 drop-shadow-lg">
          Get in Touch
        </h1>
      ...
      {/* Contact Form */}
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-12">
